...
module.exports = {
    ...
    GITHUB : process.env.GITHUB|| 'https://github.com/kandala20/kandala-xmd1',
    OWNER_NAME : process.env.OWNER_NAME || "kandala_tech",
    ...
    URL: process.env.URL || "https://raw.githubusercontent.com/kandala20/KANDALA-XMD1/main/media/kandala.jpg",  
    ...
    AUTO_STICKER : process.env.AUTO_STICKER || "no", 
    AUTO_STATUS_TEXT: process.env.AUTO_STATUS_TEXT || 'Your Status Seen By Kandala-XMD',   
    ...
    GURL: process.env.GURL  || "https://whatsapp.com/channel/0029Vb7yBSYElagyvG4Yqd0a",
    WEBSITE :process.env.GURL || "https://fee-xmd.online",
    CAPTION : process.env.CAPTION || "KANDALA-XMD",
