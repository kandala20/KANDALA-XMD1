    ...
    await repondre("API request failed. Please try again later.", {
      contextInfo: {
        externalAdReply: {
          ...
          thumbnailUrl: "https://raw.githubusercontent.com/kandala20/KANDALA-XMD1/main/media/kandala.jpg", // Replace with a suitable thumbnail URL
          sourceUrl: conf.GURL,
          mediaType: 1,
          showAdAttribution: true,
        },
